          ...
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              ...
              <CollapsableNavItem
                ...
                icon={faBed}
              >
                <NavItem title="All Patients" link={Routes.AllPatients.path} />
                <NavItem
                  title="Admit Patient"
                  link={Routes.CreatePatient.path}
                />
              </CollapsableNavItem>
              ...
              <CollapsableNavItem
                ...
                icon={faHospital}
              >
                <NavItem title="All Wards" link={Routes.AllWards.path} />
                <NavItem title="New Ward" link={Routes.CreateWard.path} />
              </CollapsableNavItem>
